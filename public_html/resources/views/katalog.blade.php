 ...
 <div class="catalog">
    ...
    <div class="side_fill">
        ...
        <ul>
            <li>
                Мясо:
                <ul>
                    <li><a href="{{ route('maso') }}">Мяcо дорогое</a></li>
     ...
     @if(Auth::check())
         <div class="product_fill">
             ...
             <form action="{{ route('search') }}" method="post" onsubmit="" class="poisk_form">
                 @csrf
                 <input type="text" name="search" class="res_f_kol" value="">
                 <input class="req_sumbol" type="submit" value="Поиск" />
             </form>
            ...
            @foreach ($product as $prod)
             ...
             @endforeach
                <div class="pag"> {{ $product->links() }}</div>
    ...
    <div class="side_fill side_fill_right">
        <div class="side_fill_right_adv">
                ...
                <img class="adv_pic" src="{{asset('storage/app/public/foto/meeet.png')}}" alt="рыба">
